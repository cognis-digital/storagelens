"""Native cognis-connect emit for storagelens — forward findings to any platform.

Maps storagelens's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    storagelens ... --format json | storagelens-emit --to stix
    storagelens-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
