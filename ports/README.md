# Ports of storagelens

The same scan logic, ported across languages so you can drop storagelens into any stack
or ship a single static binary. All ports share the rule IDs and JSON output shape.

| Language | Path | Run |
|---|---|---|
| Python (reference) | `../storagelens/` | `storagelens scan .` |
