#!/usr/bin/env sh
# Universal installer for storagelens. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/storagelens.git"
echo "Installing storagelens ..."
...
echo "Done. Run: storagelens --help"
